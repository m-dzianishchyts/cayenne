...
[source,java]
----
include::example$/persistent/Artist.java[tag=content]
----
...
----
include::example$/Main.java[tag=new-artist]
----
...
[source,java,indent=0]
----
include::example$/Main.java[tag=new-painting]
----
...
[source, java, indent=0]
----
include::example$/Main.java[tag=link-objects]
----
...
[source, java, indent=0]
----
include::example$/Main.java[tag=commit]
----
