...
----
compile 'org.apache.cayenne:cayenne-jcache:{project-version}'
----
...
NOTE: You can read about using cache in Cayenne in xref:tuning.adoc#caching[this] chapter.

You may else be interested in xref:cacheInvalidation.adoc#ext-cache-invalidation[Cache invalidation extension].
