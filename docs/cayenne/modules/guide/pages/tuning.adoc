...
Use can use xref:jCache.adoc[JCache integration module] to enable any of JCache API compatible caching providers.
...
This can be done with the help of xref:cacheInvalidation.adoc[Cache invalidation extension].
