...
We'll discuss queries in some detail in the xref:queries.adoc[Queries] chapter. The example above is self-explanatory -
...
For more flexibility, you could use the xref:queries.adoc#_selectbyid[] query instead.
