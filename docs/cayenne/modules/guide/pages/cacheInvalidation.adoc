...
----
compile 'org.apache.cayenne:cayenne-cache-invalidation:{project-version}'
----
...
NOTE: You can read more about cache and cache groups in corresponding xref:tuning.adoc#caching[chapter] of this documentation.
