...
----
compile 'org.apache.cayenne:cayenne-velocity:{project-version}'
----

== Usage

This module doesn't require any additional setup. In addition of directives mentioned in xref:queries.adoc#directives[this chapter],
