...
.^|XML
.^|No
.^|An object that contains detailed reverse engineering rules about what DB objects should be processed. For full information about this parameter see xref:introduction.adoc[DB-First Flow] chapter.
|===
...
.^|XML
a|Detailed reverse engineering rules about what DB objects should be processed. For full information about this parameter see xref:introduction.adoc[DB-First Flow] chapter. Here is some simple example:
[source,XML]
----
<dbimport>
