...
See chapter xref:revEngineering.adoc[Reverse Engineering in Cayenne Modeler]
...
Before using Cayenne in you code you need to generate java source code for persistent objects. This can be done with Modeler GUI or via xref:maven-plugin.adoc#cgen[] maven/ant plugin.
...
image::db-entity-pk.png[align="center"]
