...
Alternative approach to using xref:introduction.adoc#re-introduction[build tools] is doing reverse engineering from xref:modeler.adoc[CayenneModeler].

You can find reverse engineering tool in dataMap view on *DbImport Tab*.

== Reverse engineering options

image::re-modeler-reverseengineering-dialog.png[align="center"]
...
image::re-modeler-datasource-select.png[align="center"]
