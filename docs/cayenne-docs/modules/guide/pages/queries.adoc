...
include::partial$part2/queries/objectselect.adoc[leveloffset=-1]

include::partial$part2/queries/selectbyid.adoc[leveloffset=-1]

include::partial$part2/queries/sql.adoc[leveloffset=-1]

include::partial$part2/queries/sqlscripting.adoc[leveloffset=-1]

include::partial$part2/queries/mapped.adoc[leveloffset=-1]

include::partial$part2/queries/procedure.adoc[leveloffset=-1]

include::partial$part2/queries/ejbql.adoc[leveloffset=-1]

include::partial$part2/queries/custom.adoc[leveloffset=-1]
