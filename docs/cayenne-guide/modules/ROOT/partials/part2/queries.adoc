...
include::partial$part2/queries/objectselect.adoc[]

include::partial$part2/queries/selectbyid.adoc[]

include::partial$part2/queries/sql.adoc[]

include::partial$part2/queries/sqlscripting.adoc[]

include::partial$part2/queries/mapped.adoc[]

include::partial$part2/queries/procedure.adoc[]

include::partial$part2/queries/ejbql.adoc[]

include::partial$part2/queries/custom.adoc[]
